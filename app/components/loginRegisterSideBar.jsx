...
export default function LoginRegisterSidebar() {
    return (
        <div
            className="relative h-full min-h-full bg-[linear-gradient(145deg,rgb(30,58,138)_0%,rgb(37,99,235)_45%,rgb(59,130,246)_75%,rgb(96,165,250)_100%)] shadow-xl p-6 w-full flex flex-col overflow-hidden
                        before:content-['']
                        before:absolute
                        before:top-[-30px]
                        before:right-[-30px]
            ...
            <div className="flex gap-2 items-center mt-3">
                ...
                <h2 className={` ${bricolage.className} font-bold text-white text-2xl`}>MediStock</h2>
            </div>

            <div className="flex flex-col items-left mt-15">
                <h2 className={` ${bricolage.className} font-bold text-white text-3xl`}>The smarter way to <br></br> run your pharmacy.</h2>
                <p className={` ${bricolage.className} text-sm mt-2 leading-[1.6] text-white/70 tracking-wide`}>Join 8,400+ pharmacies already managing inventory, tracking purchases, and staying compliant — all in one place.</p>
            </div>
                ...
                {boxData.map((data) => {
                    ...
                    return (
                        <div key={data.id} className="flex gap-2 border border-white/20 rounded-xl px-4 py-4 bg-white/10 items-center">
                            ...
                            <div>
                                <h3 className={` ${bricolage.className} text-xs text-white font-bold`}>{data.heading}</h3>
                                <p className={` ${bricolage.className} text-xs text-white font-thin`}>{data.content}</p>
                            </div>
                        </div>
                    )
                })}
            ...
            <div className="relative mt-50 flex gap-4 items-center justify-center
                        before:content['']
                        before:absolute
                        before:right-10
                        before:h-20
                ...
                <p className={` ${bricolage.className} text-xs text-white`}>Trusted by <span className="font-bold">8,400+</span> pharmacies</p>
            </div>
