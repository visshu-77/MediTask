...
export default function Register() {
    ...
    return (
        <div className="w-full min-h-full">
            <div className={` ${bricolage.className} w-full min-h-full bg-white text-black flex`}>
                    ...
                    >
                        <div className="flex flex-wrap gap-x-2 gap-y-5 mt-10">
                            ...
                            <div className="flex gap-1 items-center w-full">
                                ...
                                />
                                <p className="text-xs text-text">I Agree to MediStock's <Link href='#' className="text-primary hover:underline">Terms Of Service</Link> and <Link href="#" className="text-primary hover:underline">Privacy Policy</Link></p>
                            </div>
